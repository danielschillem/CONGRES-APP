...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 mb-8">
            ...
            <form action="{{ route('soumission.en_attente') }}" method="GET">
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <a href="{{ route('soumission.en_attente', array_merge(request()->query(), ['sort' => 'document_title', 'direction' => request('sort') == 'document_title' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}"
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <a href="{{ route('soumission.en_attente', array_merge(request()->query(), ['sort' => 'author_name', 'direction' => request('sort') == 'author_name' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}"
                                   class="flex items-center hover:text-gray-700">
                                    Auteur
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <a href="{{ route('soumission.en_attente', array_merge(request()->query(), ['sort' => 'created_at', 'direction' => request('sort') == 'created_at' && request('direction') == 'asc' ? 'desc' : 'asc'])) }}"
                                   class="flex items-center hover:text-gray-700">
                                    Date de soumission
