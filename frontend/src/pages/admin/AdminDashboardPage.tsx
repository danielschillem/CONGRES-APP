    ...
    return (
        <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
            ...
            <text
                ...
                textAnchor="middle"
                className="dashboard-total-text"
            >
                {total}
            </text>
        </svg>
            ...
            <div className="border-b border-ink-200 pb-4 dark:border-ink-800">
                <h1 className="text-2xl font-semibold text-ink-950 dark:text-ink-50">
                    {isDashboard
                        ? "Tableau de bord"
                        : statutFilter !== "all"
                          ? `Soumissions - ${statutFilter}`
                          : "Toutes les soumissions"}
                </h1>
                <p className="text-gray-500 text-sm mt-1">
                    Vue d'ensemble du congrès
                </p>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex items-center gap-6">
                                    <DonutChart
                                        segments={inscriptionsStatutSegments}
                                    />
                                    <DonutLegend
                                        segments={inscriptionsStatutSegments}
                                    />
                                    ...
                                    <TableRow key={soumission.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                <Link
                                                    to={`/admin/soumissions/${soumission.id}`}
                                                >
                                                    <Button
                                                        variant="ghost"
                                                        size="icon"
